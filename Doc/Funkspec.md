...
A megrendelő bevételeit a hirdetési funkciók biztosítják, ezért a fejlesztés, design kialakítás során biztosítani kell az egyes siteokon a hirdetések elhelyezését. A projektnek nem scopja a hirdetések beillesztése.
...
|  Regisztráció  | K4     |            Kapcsolati adatok megadása             | E-mail elérhetőség rögzítése oldalak közötti navigálás nélkül.  **User field2:email**  **User field3:telefon** |
...
| Oldalfunkciók  | K14    |                  Útvonaltervezés                  | Külső útvonaltervező keresés  használata. Integrált megoldással. |
